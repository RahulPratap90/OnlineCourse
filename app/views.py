...
from app.models import Course_table ,StudentEnrollCourse
from app.forms import Course_tableForm
from app.models import Student_register
from app.forms import StudentEnrollCourseForm
